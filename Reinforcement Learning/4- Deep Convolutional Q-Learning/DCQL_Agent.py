# -*- coding: utf-8 -*-
"""
Created on Wed May 24 18:58:43 2023
...
class Agent:
    ...
    def FindBestAct(self,s):
        ...
        # burada bilfigimiz yoldan devam ediyoruz ogrendigimiz yerden devam ediyoruz
        else:
    ...
    def CaptureSample(self, sample):
        # ogrendigimiz bilgileri depoluyoruz ve depo doldugunda en arkadan bosaltıyoruz
        ...
        # epsilon degeri verdik ve asagida guncellemeler yapiyoruz
        self.epsilon = 1.0
